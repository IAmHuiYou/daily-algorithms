...
![image-20260315183023807](assets/image-20260315183023807.png)
...
[1005.K次取反后最大化的数组和 | 代码随想录](https://programmercarl.com/1005.K次取反后最大化的数组和.html)

## 我的思路

看有多少负数。如果k<=负数的个数，那尽量翻转最小的几个负数。

如果k>=负数的个数，如果k为偶数，情况同上面，如果k为奇数，留一个最大的负数。
